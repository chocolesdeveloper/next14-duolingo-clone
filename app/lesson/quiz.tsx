    ...
    if (correctOption.id === selectedOption) {
      startTransition(() => {
        upsertChallengeProgress(challenge.id)
          ...
          .catch((err) => toast.error("Somenthing went wrong. Please try again."))
      })
    } else {
      startTransition(() => {
        reduceHearts(challenge.id)
          ...
          .catch(() => toast.error("Somenthing went wrong. Please try again."))
      })
    }
  }
    ...
    <>
      ...
      <div className="flex-1">
        <div className="h-full flex items-center justify-center">
          <div className="lg:min-w-[350px] lg:w-[600px] w-full px-6 lg:px-0 flex flex-col gap-y-12">
            <h1 className="text-lg lg:text-exl text-center lg:Text-start font-bold text-neutral-700">
              {title}
            </h1>
            <div>
      ...
      <Footer disabled={peding || !selectedOption} status={status} onCheck={onContinue} />
    </>
  )
}
