    ...
    <ul className="w-full">
      <div className="flex items-center w-full p-4 gap-x-4 border-t-2">
        ...
        <div className="flex-1">
          <p className="text-neutral-700 text-base lg:text-xl font-bold">Rerfill hearts</p>
        </div>
        <Button
          onClick={onRefilHearts}
          disabled={peding || hearts === 5 || points < POINTS_TO_REFILL}
        >
          {hearts === 5 ? (
            "full"
          ) : (
      ...
      <div className="flex items-center w-full p-4 pt-8 gap-x-4 border-t-2">
        ...
        <Button onClick={onUpgrade} disabled={peding}>
